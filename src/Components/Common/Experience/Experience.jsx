...
const Experience = ({ experience }) => {
    ...
    return (
            ...
            {/* <div className='mb-7 lg:mb-0'>
                <div className=" bg-gray-100 px-10 py-10 rounded-xl">
                    <div className=" ">
                        ...
                        <h3 className="text-xl 2xl:text-[1.6rem] font-semibold mb-5 text-black">{[position]}</h3>
            ...
            <motion.div
                ...
                <div className="absolute to-bg-black-10 bg-gradient-to-t from-black/80 via-black/50 pt-32  sm:pt-48  lg:pt-64  h-full w-full flex items-end backdrop-blur-sm">
                    <div className='p-7'>
